...
extension NetworkErrorTests {
    @Test
    func message_invalidHTTPURLResponse() {
    ...
    @Test
    func message_invalidURLRequest() {
    ...
    @Test
    func message_missingDataSource() {
    ...
    @Test
    func message_unacceptableContentType() {
    ...
    @Test
    func message_unacceptableStatusCode() {
